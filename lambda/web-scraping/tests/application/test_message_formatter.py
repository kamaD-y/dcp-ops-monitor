...
class TestFormatDcpOpsMessage:
    """format_dcp_ops_message のテスト"""

    def test_format_dcp_ops_message__with_multiple_products(self):
        ...
        # when
        message = format_dcp_ops_message(assets, indicators)
...
"""
    ...
    def test_format_dcp_ops_message__with_negative_gains(self):
